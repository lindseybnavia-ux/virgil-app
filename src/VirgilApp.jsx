  ...
  <div className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-xl shadow-lg p-6 mb-6">
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      <div>
        ...
        <p className="text-blue-100 text-sm">Get started by adding your first session. You can type notes, create a voice recording or upload a photo from your journal.</p>
      </div>
    <button
  onClick={() => {
    const today = new Date().toISOString().split('T')[0];
...
{activeView === 'calendar' && (
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto">
    <div className="min-h-full flex items-start justify-center px-4 py-8">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-w-[calc(100vw-2rem)] p-6">
